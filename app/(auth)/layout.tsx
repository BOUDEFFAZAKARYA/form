  ...
  return (
    <div className="grid min-h-screen grid-cols-1 overflow-hidden md:grid-cols-3 lg:grid-cols-2">
      <AspectRatio ratio={16 / 9}>
        ...
        <Link
          href="/"
          className="absolute z-20 flex items-center text-lg font-bold tracking-tight left-8 top-6"
        >
     
         <Logo/>
        </Link>
        <div className="absolute z-20 text-base bottom-6 left-8 line-clamp-1">
          Photo by{" "}
          <a
